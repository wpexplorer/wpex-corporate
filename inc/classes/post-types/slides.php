...
if ( ! class_exists( 'WPEX_Slides_Post_Type' ) ) {
	...
	class WPEX_Slides_Post_Type {
		...
		public function register() {
			...
			$labels = array(
				'name'					=> esc_html__( 'Slides', 'corporate' ),
				'menu_name'				=> esc_html__( 'Home Slides', 'corporate' ),
				'singular_name'			=> esc_html__( 'Slides Item', 'corporate' ),
				'add_new'				=> esc_html__( 'Add New Item', 'corporate' ),
				'add_new_item'			=> esc_html__( 'Add New Slides Item', 'corporate' ),
				'edit_item'				=> esc_html__( 'Edit Slides Item', 'corporate' ),
				'new_item'				=> esc_html__( 'Add New Slides Item', 'corporate' ),
				'view_item'				=> esc_html__( 'View Item', 'corporate' ),
				'search_items'			=> esc_html__( 'Search Slides', 'corporate' ),
				'not_found'				=> esc_html__( 'No slides items found', 'corporate' ),
				'not_found_in_trash'	=> esc_html__( 'No slides items found in trash', 'corporate' )
			);
		...
		public function edit_cols( $columns ) {
			$slides_columns = array(
				...
				"slides_thumbnail"	=> esc_html__('Thumbnail', 'corporate')
			);
