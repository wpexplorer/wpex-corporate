...
Once the item is downloaded the zip folder will be called "wpex-corporate-{version}". Unzip the theme and remove the version at the end or name the theme anything you want. Now, re-zip and upload your edited version to WordPress.
